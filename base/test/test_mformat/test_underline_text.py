...
class TestWrapTextValidation:
    ...
    def test_newline_raises(self, text):
...
class TestWrapTextNoWrapping:
    ...
    def test_short_text_single_row(self, text, max_len):
...
class TestWrapTextWrapping:
    ...
    def test_multiple_spaces_collapsed_at_wrap_point(self):
...
class TestWrapTextLongWords:
    ...
    def test_long_word_at_start(self):
    ...
    def test_long_word_between_short_words(self):
...
class TestUnderlineTextValidation:
    ...
    def test_newline_in_text_raises(self):
        """Test that newlines in text raise ValueError."""
        spec = UnderlineSpec(
            pattern='-', empty_lines_between=0, empty_lines_after=0
        )
...
class TestUnderlineTextSingleLine:
    ...
    def test_single_char_pattern_with_lines_after(self):
    ...
    def test_single_line_between_has_no_effect(self, between, after):
...
class TestUnderlineTextMultiLine:
    ...
    def test_two_lines_no_empty_between(self):
    ...
    def test_two_lines_with_multiple_empty_between(self):
    ...
    def test_two_lines_with_empty_after(self):
    ...
    def test_empty_between_only_between_rows_not_after_last(self):
    ...
    def test_two_lines_empty_line_combinations(self, between, after):
...
class TestUnderlineTextLongWords:
    ...
    def test_single_long_word_underlined(self):
    ...
    def test_long_word_underline_matches_word_length(self):
