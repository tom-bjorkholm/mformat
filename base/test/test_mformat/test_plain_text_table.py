...
class TestLineWrapsPerColumnWidth:
    ...
    def test_max_width_always_has_zero_wraps(self):
...
class TestSelectColumnWidthsValidation:
    ...
    def test_invalid_data_raises(self, data):
    ...
    def test_empty_row_raises(self, data):
    ...
    def test_different_column_counts_raises(self):
    ...
    def test_non_string_cell_raises(self):
    ...
    def test_max_line_length_10_accepted(self):
        """Test max_line_length=10 is accepted."""
        result = select_column_widths(
            [['a']], _simple_spec(), 10)
        assert result == [1]

    def test_too_short_for_borders_raises(self):
    ...
    def test_too_short_for_data_raises(self):
...
class TestSelectColumnWidthsNoWrap:
    ...
    def test_multiple_rows_picks_widest(self):
...
class TestSelectColumnWidthsWithWrap:
    ...
    def test_single_column_wraps(self):
    ...
    def test_two_columns_one_wraps(self):
    ...
    def test_optimal_minimizes_total_wraps(self):
    ...
    def test_tight_fit_only_option(self):
    ...
    def test_wrapping_with_multiple_rows(self):
...
class TestAlignCellValue:
    ...
    def test_left(self, value, width, expected):
    ...
    def test_right(self, value, width, expected):
    ...
    def test_center(self, value, width, expected):
    ...
    def test_empty_value_same_for_all_alignments(self):
...
class TestFormatBorderRow:
    ...
    def test_multi_char_horizontal_pattern(self):
        """Test with multi-character horizontal pattern."""
        result = format_border_row(
            '+', '+', '=-', '+', [4])
        assert result == '+=-=-+'

    def test_multi_char_horizontal_truncation(self):
...
class TestFormatTopBorder:
    ...
    def test_rst_spec_single_column(self):
...
class TestGetPlainTextTableValidation:
    ...
    def test_too_many_alignment_elements_raises(self):
...
class TestGetPlainTextTableNoWrap:
    ...
    def test_single_alignment_broadcast(self):
...
class TestGetPlainTextTableWrapping:
    ...
    def test_one_column_wraps(self):
    ...
    def test_one_cell_wraps_other_padded(self):
    ...
    def test_both_columns_wrap(self):
    ...
    def test_wrapping_with_inner_border(self):
    ...
    def test_wrapped_lines_within_max_length(self):
...
class TestGetPlainTextTableRst:
    ...
    def test_rst_inner_border_uses_correct_patterns(self):
    ...
    def test_rst_data_rows_consistent_width(self):
