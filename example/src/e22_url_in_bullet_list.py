...
def example_url_in_bullet_list(format_name: str, file_name: str) -> None:
    ...
    with create_mf(format_name=format_name, file_name=file_name) as mf:
        ...
        mf.start_heading(level=1, text='URL in bullet list example')
        # Start a bullet list with an item containing a URL.
        mf.start_bullet_item(text='This is a bullet list with a URL:')
        ...
        mf.start_bullet_item(text='Another bullet point with a bold URL:')
        ...
        mf.start_bullet_item(text='A bullet point with an italic URL:')
        ...
        mf.start_bullet_item(text='Last point with an italic and bold URL:')
