...
def numbered_nested_example(format_name: str,
    ...
    with create_mf(format_name=format_name, file_name=file_name) as mf:
        ...
        mf.new_heading(level=1, text='Nested numbered list example')
        ...
        mf.new_numbered_point_item('Another item at level 2.',
                                   level=2)
        mf.new_numbered_point_item('And an item at level 3.',
                                   level=3)
...
if __name__ == "__main__":
    example_main(example_text='Nested numbered list',
                 function=numbered_nested_example)
