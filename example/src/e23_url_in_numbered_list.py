...
def example_url_in_numbered_list(format_name: str, file_name: str) -> None:
    ...
    with create_mf(format_name=format_name, file_name=file_name) as mf:
        ...
        mf.start_numbered_point_item(text='A numbered point with a bold URL:')
        ...
        mf.start_numbered_point_item(text='And with an italic URL:')
        ...
        mf.start_numbered_point_item(text='And with an italic and bold URL:')
