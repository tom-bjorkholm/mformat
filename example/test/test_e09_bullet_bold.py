...
"""Test the e09_bullet_bold example."""
...
from e09_bullet_bold import bullet_bold_example  # pylint: disable=wrong-import-position,wrong-import-order # noqa: E402,E501
...
def test_e09_bullet_bold_html(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e09_bullet_bold_docx(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e09_bullet_bold_odt(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e09_bullet_bold_rtf(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e09_bullet_bold_txt(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e09_bullet_bold_rst(capsys: pytest.CaptureFixture[str]) -> None:
    """Test the bullet_bold_example function with the reST format."""
    expected_txt = [
        'Bullet list with bold text example',
        '**However,',
        'this bold text is added to it.**',
    ...
    check_rst_func(bullet_bold_example, expected_txt, expected_error)
    check_capsys_silent(capsys)
