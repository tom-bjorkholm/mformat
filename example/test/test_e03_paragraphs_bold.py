...
"""Test the e03_paragraphs_bold example."""
...
from e03_paragraphs_bold import paragraphs_bold_example  # pylint: disable=wrong-import-position,wrong-import-order # noqa: E402,E501
...
def test_e03_paragraphs_bold_md(capsys: pytest.CaptureFixture[str]) -> None:
    """Test the paragraphs_bold_example function with the md format."""
...
def test_e03_paragraphs_bold_html(capsys: pytest.CaptureFixture[str]) -> None:
    """Test the paragraphs_bold_example function with the html format."""
    expected_txt = EXPECTED_HTML_TEXT
    check_html_func(paragraphs_bold_example, expected_txt)
    check_capsys_silent(capsys)


def test_e03_paragraphs_bold_docx(capsys: pytest.CaptureFixture[str]) -> None:
    """Test the paragraphs_bold_example function with the docx format."""
...
def test_e03_paragraphs_bold_odt(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e03_paragraphs_bold_rtf(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e03_paragraphs_bold_txt(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e03_paragraphs_bold_rst(capsys: pytest.CaptureFixture[str]) -> None:
