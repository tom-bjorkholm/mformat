...
def test_e05_heading_md(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e05_heading_txt(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e05_heading_html(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e05_heading_docx(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e05_heading_odt(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e05_heading_rtf(capsys: pytest.CaptureFixture[str]) -> None:
    """Test the heading_example function with the rtf format."""
    expected_txt = EXPECTED_HTML_TEXT
    check_rtf_func(heading_example, expected_txt)
    check_capsys_silent(capsys)


def test_e05_heading_latex(capsys: pytest.CaptureFixture[str]) -> None:
    """Test the heading_example function with the LaTeX format."""
    expected_txt = EXPECTED_LATEX_TEXT
    check_latex_func(heading_example, expected_txt)
    check_capsys_silent(capsys)


def test_e05_heading_rst(capsys: pytest.CaptureFixture[str]) -> None:
