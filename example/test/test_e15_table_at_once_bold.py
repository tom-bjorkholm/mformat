...
def test_e15_table_at_once_bold_html(capsys):
...
def test_e15_table_at_once_bold_docx(capsys):
...
def test_e15_table_at_once_bold_odt(capsys):
...
def test_e15_table_at_once_bold_rst(capsys):
