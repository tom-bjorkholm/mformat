...
def test_e14_table_at_once_md(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e14_table_at_once_html(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e14_table_at_once_docx(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e14_table_at_once_odt(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e14_table_at_once_rtf(capsys: pytest.CaptureFixture[str]) -> None:
    """Test the example_table_at_once function with the rtf format."""
    expected_txt = EXPECTED_HTML_TEXT
    check_rtf_func(example_table_at_once, expected_txt)
    check_capsys_silent(capsys)


def test_e14_table_at_once_latex(capsys: pytest.CaptureFixture[str]) -> None:
    """Test the example_table_at_once function with the latex format."""
    expected_txt = EXPECTED_LATEX_TEXT
    check_latex_func(example_table_at_once, expected_txt)
    check_capsys_silent(capsys)
...
def test_e14_table_at_once_txt(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e14_table_at_once_rst(capsys: pytest.CaptureFixture[str]) -> None:
