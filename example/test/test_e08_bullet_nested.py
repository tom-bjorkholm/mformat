...
from e08_bullet_nested import bullets_example  # pylint: disable=wrong-import-position,wrong-import-order # noqa: E402,E501
...
def test_e08_bullet_nested_md(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e08_bullet_nested_html(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e08_bullet_nested_docx(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e08_bullet_nested_odt(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e08_bullet_nested_rtf(capsys: pytest.CaptureFixture[str]) -> None:
    """Test the bullets_example function with the rtf format."""
    expected_txt = EXPECTED_HTML_TEXT
    check_rtf_func(bullets_example, expected_txt)
    check_capsys_silent(capsys)


def test_e08_bullet_nested_latex(capsys: pytest.CaptureFixture[str]) -> None:
    """Test the bullets_example function with the latex format."""
    expected_txt = EXPECTED_LATEX_TEXT
    check_latex_func(bullets_example, expected_txt)
    check_capsys_silent(capsys)
...
def test_e08_bullet_nested_txt(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_e08_bullet_nested_rst(capsys: pytest.CaptureFixture[str]) -> None:
    """Test the bullets_example function with the reST format."""
    expected_txt = [
        'Nested bullet list example',
        '* This is the first bullet point item at level 1.\n'
        '\n'
    ...
    check_rst_func(bullets_example, expected_txt, expected_error)
    check_capsys_silent(capsys)
