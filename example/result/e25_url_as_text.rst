...
are here. https://bitbucket.org/tom-bjorkholm/mformat/src/master/example/src
and The produced output files are here.
https://bitbucket.org/tom-bjorkholm/mformat/src/master/example/result

The URLs are shown as text instead of clickable links. This might be useful
when you want to copy the URLs to the clipboard and paste them into another
