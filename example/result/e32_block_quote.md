...
Block quotes are used to highlight quoted text or to draw attention to important
information.
...
> For more information, visit [Example Website](http://example.com) for details.

## Block Quote with Code

> The function `new_block_quote()` starts a new block quote, and `add_text()`
> adds more text to it.
