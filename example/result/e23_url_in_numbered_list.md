...
3. And with an italic URL:
   *[This italic URL link to the examples result.](https://bitbucket.org/tom-bjorkholm/mformat/src/master/example/result)*

4. And with an italic and bold URL:
   ***[This italic and bold URL link to the examples.](https://bitbucket.org/tom-bjorkholm/mformat/src/master/example/src)***
