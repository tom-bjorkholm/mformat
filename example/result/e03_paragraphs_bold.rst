**With new_paragraph we can start a paragraph with the first sentence in
bold.** Use add_text to add text without bold to the paragraph. *Use add_text
to add text in italic to the paragraph.* ***Use add_text to add text in bold
and italic.***
