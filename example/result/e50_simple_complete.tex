...
\section{Heading with URL to \href{https://bitbucket.org/tom-bjorkholm/mformat/src/master/example/src/e50\_simple\_complete.py}{the example file}}

As you can see, we can add URLs to both headings and paragraphs. It is also possible to add URLs to text, for instance the URL to the example file is added here. \href{https://bitbucket.org/tom-bjorkholm/mformat/src/master/example/src/e50\_simple\_complete.py}{The same example file}
