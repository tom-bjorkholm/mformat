...
Heading with URL to `the example file <https://github.com/tom-bjorkholm/mformat/blob/master/example/src/e50_simple_complete.py>`_
---------------------------------------------------------------------------------------------------------------------------------
...
here.
`The same example file <https://github.com/tom-bjorkholm/mformat/blob/master/example/src/e50_simple_complete.py>`_
